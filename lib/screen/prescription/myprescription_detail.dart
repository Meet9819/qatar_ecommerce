...
class _mypredetailState extends State<mypredetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton:  widget.todo.statustitle=='PARTIAL_APPROVAL' || widget.todo.statustitle=='APPROVED'?
        ...
        FloatingActionButton.extended(
          ...
          onPressed: () {
           ...
           Navigator.push(context,
                MaterialPageRoute(builder: (context) => Prescription_Address_screen(pre_id:widget.todo.id)));
          },
