...
final String quantity;
  ...
  // final String email;
  CartItem({this.img, this.title,  this.price, this.id, this.finalprice,this.quantity,});
//List data;
...
int sum;
  ...
  Widget build(BuildContext context) {
   ...
   /* bottomNavigationBar: BottomNavigationBar(
      ...
      /*  bottomNavigationBar: new Stack(
       ...
       floatingActionButton:Container(  height: 50.0,
            width: 150.0,
            //child: FittedBox(
            child: FloatingActionButton.extended(
              ...
              onPressed: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Address_screen(total: totalid)));
              },
  ...
  Future<List<CartItem>> _fetchCartItem() async {
    ...
    var url = 'http://sharegiants.in/ruchi/cart_api.php';
    var response = await http.post(url, body: json.encode(data));
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage('http://sharegiants.in/ruchi/images/item/'+data[index].img),
                            fit: BoxFit.fill)),
                  ),
                  Expanded(
                      child: Padding(
                              ...
                              GestureDetector(
                                ...
                                onTap: () {
                                  setState(() {
                                    ...
                                    addquantity(finalprice[index],_counter_[index],data[index].id);
                                  });
                                },
                              ),
                              SizedBox(width: 10),
