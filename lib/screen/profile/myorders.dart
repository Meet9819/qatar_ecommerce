...
//List data;
  factory OrderItem.fromJson(Map<String, dynamic> json) {
    return OrderItem(
      ...
      ecommerceorderpaymentstatustitle: json['ecommerceorderpaymentstatustitle'],
      amount: json['amount'],
...
class _myorderState extends State<myorder> {
  ...
  Future<List<OrderItem>> _fetchmyorder() async {
    ...
    var url = 'http://sharegiants.in/ruchi/myorders.php';
           ...
           child: Padding(
            ...
            child: Card(
             ...
             Row( mainAxisAlignment: MainAxisAlignment.spaceBetween,children: <Widget>[
               ...
               if(data[index].ecommerceorderstatus=="RECEIVED_ORDER")(
                   Padding(
                       padding: const EdgeInsets.only(right: 10),
                       child:Chip(
                         backgroundColor: Colors.red,
                         label: Text(data[index].ecommerceorderstatus,      style: TextStyle(
                             fontSize: 14, fontWeight: FontWeight.bold,color: Colors.white),),
                       )
                   ))
             else  if(data[index].ecommerceorderstatus=="IN_PROCESS")(
                   Padding(
                       padding: const EdgeInsets.only(right: 10),
                       child:Chip(
               ...
               else  if(data[index].ecommerceorderstatus=="SHIPPED - OUT_FOR_DELIVERY")(
                     Padding(
                         padding: const EdgeInsets.only(right: 10),
                         child:Chip(
                 ...
                 else  if(data[index].ecommerceorderstatus=="DELIVERED")(
                       Padding(
                         padding: const EdgeInsets.only(right: 10),
                         child:Chip(
