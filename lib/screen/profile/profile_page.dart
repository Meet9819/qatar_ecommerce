...
class _UserProfilePageState extends State<UserProfilePage> {
  var useremail;  var fname,addline,latitude,longitude;
  ...
  _getLocation() async
  {
    ...
    prefs.setString('featureName', first.featureName,);
    prefs.setString('addressLine', first.addressLine,);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  _myorders(),
                    ...
                    addline ==null?Text(''):
                    Center(
                        child: Text(addline+' '+latitude+' '+longitude,textAlign: TextAlign.center,style: TextStyle(fontSize: 12,),)),
                  ],
                ),
              ),
    )
