 ...
 String firstname,lastname,email,mobile;
  ...
  Future update_acc() async {
    ...
    dynamic token = await getStringValues();
      ...
      // SERVER API URL
      var url = 'http://sharegiants.in/ruchi/update_account_details.php';
print(firstname);print(lastname);print(email);
  ...
  Future<List<Account>> _fetchaccount() async {
    ...
    var url = 'http://sharegiants.in/ruchi/account_details.php';
    var response = await http.post(url, body: json.encode(data));
...
firstname=data[index].first_name;lastname=data[index].last_name;email=data[index].email;
          return InkWell(
            child: Padding(
