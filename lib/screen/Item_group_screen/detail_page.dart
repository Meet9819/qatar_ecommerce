...
class _ListDetailsState extends State<ListDetails> {
  ...
  String selectedvalue; String cart_total;
  ...
  getStringValuesSF() async {
    var url2 = 'http://sharegiants.in/ruchi/getcart_count.php';
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child:InkWell(
                            onTap: (){
                            Navigator.push(
                                context, MaterialPageRoute(builder: (context) => Reviews_screen(itemproductid:widget.todo.itemproductgroupid)));
                            },
                         child: Text("View Reviews",style: TextStyle(
                              fontSize: 12, color:LightColor.midnightBlue,fontWeight: FontWeight.bold),),
                          )),
                      ),
                      SizedBox(height: 10),
]):Row(
