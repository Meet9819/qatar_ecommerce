...
double starrating;
  ...
  Future<List<reviews_data>> _fetch_reviews_data() async {
    ...
    var url = 'http://sharegiants.in/ruchi/customer_reviews.php';
  ...
  Future removereviews(cust_id,id) async {
    ...
    if(cust_id!=token){
      ...
      var url = 'http://sharegiants.in/ruchi/remove_reviews.php';
      var data = { 'id': id};
      var response = await http.post(url, body: json.encode(data));
  ...
  Widget build(BuildContext context) {
    ...
    Future user_review() async {
      ...
      {
        var url = 'http://sharegiants.in/ruchi/add_customer_reviews.php';
