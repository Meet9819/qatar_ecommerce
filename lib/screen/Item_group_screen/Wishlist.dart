...
print(token);print(itemid);
    var url='http://sharegiants.in/ruchi/removewishlist.php';
  ...
  Future<List<Item>> _fetchItem() async {
    ...
    var url = 'http://sharegiants.in/ruchi/wishlist_api.php';
    var response = await http.post(url, body: json.encode(data));
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                       ...
                       image: DecorationImage(
                            image:
                            NetworkImage('http://sharegiants.in/ruchi/images/item/'+data[index].url),
                            fit: BoxFit.fill)
                    ),
                  ),
                  Expanded(
